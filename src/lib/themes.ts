...
export const THEMES: Theme[] = [
  // ===== 现有主题（色差修复） =====
  {
    ...
    name: '玫瑰',
    nameEn: 'Rose',
    description: '玫瑰色调，花瓣绽放的柔润',
    colors: {
      'jai-bg': '#DCA0AA',
      'jai-secondary': '#C88898',
      'jai-accent': '#A86878',
      'jai-card': '#F8E8EC',
      'jai-card-border': '#D0989A',
      'jai-input-bg': '#E8B8C0',
      'jai-text': '#3A1820',
      ...
      'jai-bubble': '#F0D0D5',
      'jai-bubble-user': '#C08898',
      'jai-bubble-user-text': '#3A1820',
      'jai-btn-text': '#FFFFFF',
    },
  },
  {
  ...
  },
  {
    ...
    name: '靛青',
    nameEn: 'Teal',
    description: '靛青色调，深海与宝石的沉静',
    colors: {
      'jai-bg': '#A0B8C8',
      'jai-secondary': '#88A8B8',
      'jai-accent': '#5080A0',
      'jai-card': '#E0E8EE',
      'jai-card-border': '#98B0C0',
      'jai-input-bg': '#C0D0D8',
      'jai-text': '#1A2E3A',
      'jai-text-secondary': '#4A6878',
      'jai-muted': '#C0D0D8',
      'jai-success': '#4898A0',
      'jai-thinking': '#a78bfa',
      'jai-shadow': 'rgba(100, 150, 180, 0.20)',
      'jai-shadow-hover': 'rgba(100, 150, 180, 0.30)',
      'jai-bubble': '#C8D8E2',
      'jai-bubble-user': '#7898A8',
      'jai-bubble-user-text': '#FFFFFF',
      'jai-btn-text': '#FFFFFF',
    },
  },
  ...
  },
  {
    ...
    name: '靛青',
    nameEn: 'Indigo',
    description: '靛青色调，深夜湖面的深邃',
    colors: {
      'jai-bg': '#7A8FA0',
      'jai-secondary': '#6A7E90',
      'jai-accent': '#4A6070',
      'jai-card': '#E0E8EE',
      'jai-card-border': '#8898A8',
      'jai-input-bg': '#90A8B8',
      'jai-text': '#15202A',
      'jai-text-secondary': '#3A4A58',
      'jai-muted': '#90A8B8',
      'jai-success': '#508878',
      'jai-thinking': '#7080F0',
      'jai-shadow': 'rgba(70, 100, 130, 0.22)',
      'jai-shadow-hover': 'rgba(70, 100, 130, 0.32)',
      'jai-bubble': '#A0B8C8',
      'jai-bubble-user': '#5A7888',
      'jai-bubble-user-text': '#15202A',
      'jai-btn-text': '#15202A',
    },
  },
