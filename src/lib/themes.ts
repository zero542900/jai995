...
export const THEMES: Theme[] = [
  ...
  },
  {
    id: 'midnight',
    name: '暮蓝',
    nameEn: 'Twilight Blue',
    description: '淡蓝暮色，天边最后一抹蓝',
    colors: {
      'jai-bg': '#A8B8D0',
      'jai-secondary': '#8EA0BC',
      'jai-accent': '#6E88A8',
      'jai-card': '#FFFFFF',
      'jai-card-border': '#A0B0C8',
      'jai-input-bg': '#C0CEDF',
      'jai-text': '#2A3650',
      'jai-text-secondary': '#5A6E88',
      'jai-muted': '#C0CEDF',
      'jai-success': '#5AA098',
      'jai-thinking': '#8b9ff6',
      'jai-shadow': 'rgba(120, 150, 190, 0.20)',
    },
  },
  {
    id: 'warmnight',
    name: '暖杏',
    nameEn: 'Warm Apricot',
    description: '暖杏色调，午后阳光的温存',
    colors: {
      'jai-bg': '#E0C0A0',
      'jai-secondary': '#D0A880',
      'jai-accent': '#C09068',
      'jai-card': '#FFFFFF',
      'jai-card-border': '#D8B898',
      'jai-input-bg': '#ECDCB8',
      'jai-text': '#4A3420',
      'jai-text-secondary': '#8A6848',
      'jai-muted': '#ECDCB8',
      'jai-success': '#5AA078',
      'jai-thinking': '#c898f0',
      'jai-shadow': 'rgba(180, 140, 100, 0.20)',
    },
  },
  {
    id: 'daylight',
